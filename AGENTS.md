...
The daily cron is UTC 00:00, equal to 08:00 Asia/Shanghai. The script uses `--min-run-interval-hours 36`, creating an effective every-two-days cadence. The local Codex automation is disabled; GitHub Actions is the only production scheduler.
